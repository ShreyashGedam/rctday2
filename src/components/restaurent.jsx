...
export const Restaurent = () =>
{
    ...
    function cash()
    {
        var arr2 = arr.filter( (e,i) =>
        {
            return (e.method.cash == true && e.method.card == false && e.method.upi == false)
        })
        console.log(arr2)
        setArray(arr2)
    }
    ...
    function card()
    {
        var arr2 = arr.filter( (e,i) =>
        {
            return (e.method.cash == false && e.method.card == true && e.method.upi == false)
        })
        console.log(arr2)
        setArray(arr2)
    }
            ...
            {array.map(  (e,i) =>
             <div key={i} className="boxes">
                ...
                <div className="content">
                    ...
                    <div className="payment">This Rerstaurent accepts__
